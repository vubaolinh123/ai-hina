...
class RuntimeErrorCode(StrEnum):
    ...
    MINECRAFT_GOAL_BAD_REQUEST = "E_MINECRAFT_GOAL_BAD_REQUEST"
    MINECRAFT_GOAL_DENIED = "E_MINECRAFT_GOAL_DENIED"
    MINECRAFT_GOAL_MODEL = "E_MINECRAFT_GOAL_MODEL"
    MINECRAFT_GOAL_UNAVAILABLE = "E_MINECRAFT_GOAL_UNAVAILABLE"
