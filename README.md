...
Trạng thái hiện tại: **M02 — safety, permissions và audit đang triển khai**.
M01 runtime spine đã fast-promote. HTTP control plane, WebSocket realtime,
SQLite journal, lifecycle, metrics, capability policy, emergency controls và
Hina Dev Console đều có mã chạy thật. Model hội thoại, speech engine và avatar
thật chưa được tích hợp; các phần đó thuộc các module sau.
