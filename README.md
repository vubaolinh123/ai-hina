...
Trạng thái hiện tại: **M03 — text brain đã có vertical slice để owner test**.
M01 runtime spine và M02 safety đã fast-promote. Hina Dev Console hiện có chat
text thật qua Ollama/OpenAI-compatible local, persona Hina có version, turn FSM,
interrupt, short-term memory/replay, provider health, circuit breaker và GPU
resource lease. Speech engine và avatar thật chưa được tích hợp.
