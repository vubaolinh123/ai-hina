...
Trạng thái hiện tại: **M03 — text brain đang triển khai**. M01 runtime spine và
M02 safety đã fast-promote. HTTP control plane, WebSocket realtime, SQLite
journal, lifecycle, metrics, capability policy, sanitation, moderation,
emergency controls và Hina Dev Console đều có mã chạy thật. Model hội thoại,
speech engine và avatar thật chưa được tích hợp; các phần đó thuộc các module
tiếp theo.
...
Ứng dụng này chạy hạ tầng M01–M02 thật và không giả lập câu trả lời AI.
